...
#define CUR_UPN(N) "\x1b[" ANSI_CODES_H_STR_CONV(N) "A"
#define CUR_DOWNN(N) "\x1b[" ANSI_CODES_H_STR_CONV(N) "B"
#define CUR_RIGHTN(N) "\x1b[" ANSI_CODES_H_STR_CONV(N) "C"
#define CUR_LEFTN(N) "\x1b[" ANSI_CODES_H_STR_CONV(N) "D"

// CUR_{direction}_LINE moves cursor to the beg of line N lines up/down
#define CUR_UP_LINE "\x1b[1E"
#define CUR_DOWN_LINE "\x1b[1F"

#define CUR_UP_LINEN(N) "\x1b[" ANSI_CODES_H_STR_CONV(N) "E"
#define CUR_DOWN_LINEN(N) "\x1b[" ANSI_CODES_H_STR_CONV(N) "F"

#define CUR_TO_COLN(N) "\x1b[" ANSI_CODES_H_STR_CONV(N) "G"
...
// SET_FORE... and SET_BACK... codes not working correctly
#define SET_GRAPHICS(COLOR) "\x1b[" ANSI_CODES_H_STR_CONV(COLOR) "m"
// #define SET_FORE_COLOR_ID(ID) "\x1b[38;5;$" ANSI_CODES_H_STR_CONV(ID) "m"
// #define SET_BACK_COLOR_ID(ID) "\x1b[48;5;$" ANSI_CODES_H_STR_CONV(ID) "m"
// #define SET_FORE_COLOR_RGB(R,G,B) "\x1b[38;2;" ANSI_CODES_H_STR_CONV(R) ";" ANSI_CODES_H_STR_CONV(G) ";" ANSI_CODES_H_STR_CONV(B) "m"
// #define SET_BACK_COLOR_RGB(R,G,B) "\x1b[48;2;" ANSI_CODES_H_STR_CONV(R) ";" ANSI_CODES_H_STR_CONV(G) ";" ANSI_CODES_H_STR_CONV(B) "m"

#define CUR_INVISIBLE "\x1b[?25l"
#define CUR_VISIBLE "\x1b[?25h"

#define ANSI_CODES_H_STR_CONV(s) #s
